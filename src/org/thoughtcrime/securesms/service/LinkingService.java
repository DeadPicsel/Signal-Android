...
public class LinkingService extends Service {
  ...
  private void handleLinkIntent(final Intent linkIntent) {
    try {
      ...
      accountManager.setGcmId(token);
      TextSecurePreferences.setFcmToken(this, token.get());
      TextSecurePreferences.setFcmTokenLastSetTime(this, System.currentTimeMillis());
